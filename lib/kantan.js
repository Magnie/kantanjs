function attach_kantan(controller) {
    ...
    function _eval_text() {
        let elements = document.querySelectorAll(TEXT_SELECTOR)
        for (const element of elements) {
            let value = element.getAttribute(TEXT_ATTR)
            value = _eval_value({element, value})
    ...
    function _eval_for() {
        ...
        for (const element of elements) {
            ...
            for (const item of items) {
                ...
                console.log(new_child.$scope[item_name])
    ...
    function _eval_value({ element, value }) {
        ...
        console.log(element.$scope, value)
